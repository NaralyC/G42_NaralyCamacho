...
public class PersonClass {
    ...
    public PersonClass(int nro_documento, String nombre, String tipo_doc, String fecha_nacimiento, String estado_civil, String ocupacion, boolean hijos) {
    ...
    public String funcion_consultar_info_P(){
        return "Consulta de información de la persona\n*****FORMA 1: Función*****" + getNro_documento() + " " + getNombre() + " " + getTipo_doc() + " " + getFecha_nacimiento() + " " + getEstado_civil() + " " + getOcupacion() + " " + isHijos();
    }
    
    //El método lo debemos declarar utilizando la palabra reservada VOID
    public void metodo_consultar_info_P(){
        System.out.println("Consulta de información de la persona\n*****FORMA 2: Método*****" + getNro_documento() + " " + getNombre() + " " + getTipo_doc() + " " + getFecha_nacimiento() + " " + getEstado_civil() + " " + getOcupacion() + " " + isHijos()); 
    }    
}
